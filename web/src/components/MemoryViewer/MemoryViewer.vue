...
import { MifareClassicValueBlock } from "@/models/MifareClassic/blocks/MifareClassicValueBlock";
...
<template>
  <section class="MemoryViewer" :class="{
    ...
    <footer>
      ...
      <div v-if="block instanceof MifareClassicValueBlock" class="color-4">
